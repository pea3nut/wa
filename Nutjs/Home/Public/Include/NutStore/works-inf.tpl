<header class="page-header">
    <h1>{$_data.works.works_name}<small class="pull-right">- By：{$_data.author.nickname|default=$_data.author.name}</small></h1>
    <p>更新次数：{$_data.works.update_number} 次&nbsp;&nbsp;&nbsp;最后更新：{$_data.works.update_date}</p>
    <p>{$_data.works.works_intro}</p>
    <p>价格：{$_data.works.price} 果仁</p>
    <p>
     购买：{:count($data['buy'])} 人&nbsp;&nbsp;
