...
<block name="body">
    <article class="container text-body">
        <div class="col-xs-12 col-sm-8 center-block no-float">
            ...
            <p>Web开发协会自诞生以来一直致力于人才培养、推广W3C标准、推动网络文明。2015年2月25日，协会网站Nutjs上线，在网站中提供了大量的学习资源与资料以供会员免费使用。</p>
            <p>我们一直坚持开源并以非盈利为目的，希望能成为最具认可的Web开发学习组织并一直努力着！因为我们认为，作为一名Web开发者，在自己所在的高校推广Web开发技术不仅是<strong>荣誉</strong>，更是<strong>使命</strong>！</p>
